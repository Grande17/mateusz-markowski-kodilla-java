...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://grande17.github.io";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        final String XPATH_TASK_NAME = "//form[contains(@action, \"https://grande-tasks.herokuapp.com/v1/tasks\")]/fieldset[1]/input";
        final String XPATH_TASK_CONTENT = "//form[contains(@action, \"https://grande-tasks.herokuapp.com/v1/tasks\")]/fieldset[2]/textarea";
        final String XPATH_ADD_BUTTON = "//form[contains(@action, \"https://grande-tasks.herokuapp.com/v1/tasks\")]/fieldset[3]/button";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("@gmail.com");		        // [3]
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm ->
                        anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                                .getText().equals(taskName))
                .forEach(button-> {
                    WebElement buttonElement = button.findElement(By.xpath(".//button[@data-task-delete-button]"));
                    buttonElement.click();
                });
        Thread.sleep(5000);
    }
